...
<template>
  <Layout id="skills" class="dark:bg-darkBgColor pt-12 lg:pt-5 transition-all duration-500">
    ...
    <div class="grid mt-12 grid-cols-3 w-[90%] sm:w-[60%] lg:w-[50%] mx-auto relative rounded-full border dark:border-darkTextColor/40 border-borderColor">
      ...
      <div
          :class="activeTab === 'front_end' ? 'translate-x-[2%]' : activeTab === 'back_end' ? 'translate-x-[100%]' : 'translate-x-[201.4%]'" class="bg-highlightPrimary/10 dark:bg-highlightPrimary/50 absolute h-[85%] rounded-full top-[50%] w-[33%] transform transition-all duration-700 translate-y-[-50%]"></div>
